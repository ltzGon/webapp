        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6 col-md-8 col-sm-10">
                ...
                <div class="card border-warning">
                    <div class="card-header bg-warning text-dark">แก้ไขกระทู้</div>
                    <div class="card-body">
                        <?php
                        ...
                        <form action="editpost_save.php" method="post">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-9">
                                    <textarea id="comment" name="comment" rows="8" class="form-control" required><?php echo $row1['1']?></textarea>
                                </div>
                            </div>
                            <div class="row mt-3">
